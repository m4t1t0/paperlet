...
from sqlalchemy import Column, DateTime, String, Table, ForeignKey, Integer
...
subscriptions_table = Table(
    ...
    Column(
        "external_subscription_id", String(255), unique=True, nullable=True, index=True
    ),
...
writer_subscribers_table = Table(
    "writer_subscribers",
    metadata,
    Column(
        "writer_id",
...
writer_followers_table = Table(
    ...
    Column("followed_at", DateTime, default=datetime.utcnow, nullable=False),
)
